...
def calc_deformation_dislocation(rho_prev, time_step, temperature, strain,
                                 strain_rate_initial, c1, c2, c3,
    ...
    D_def = d0 * math.exp(-2 * strain / math.sqrt(3))
